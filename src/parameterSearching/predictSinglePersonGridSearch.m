function [raw_label, all_predicted_locs, merge_locs, real_pos] = predictSinglePersonGridSearch(raw_axis_x,raw_axis_y, raw_axis_z,raw_label, min_length, target_id, pre_threshold, bak_threshold, check_win)
